    ...
    <div class="card shadow mb-5">
        <div class="card-body">
            ...
            <?php if($invoice['status'] == 0){ ?>
                <a href="<?= base_url(); ?>administrator/confirm_proof/<?= $invoice['invoice_code']; ?>" onclick="return confirm('Yakin pembeli sudah melakukan pembayaran?');" class="btn btn-info btn-sm">Sudah Bayar</a>
